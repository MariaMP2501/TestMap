...
const Navbar: FunctionComponent = () => {
  ...
  const leftSectionStyle = {
    display: 'flex',
    position: 'relative', // Ajout de la position relative pour le positionnement absolu de l'image SVG
    zIndex: 1, // Mettre le z-index à une valeur supérieure à l'image de fond pour le superposer
  };
  ...
  const buttonsContainerStyle = {
    marginLeft: 'auto', // Pour aligner les boutons à droite
    display: 'flex',
    marginTop: '-3rem',
    gap: '20px',
    marginRight: '20px',
