...
import MapCard from './MapCard'; // Importez votre composant MapCard ici
...
const MapAddresses: React.FC = () => {
  ...
  const handleFindRoute = () => {
    ...
    // pour trouver un itinéraire et l'afficher sur la carte Mapbox
    // Appelez une fonction dans MapCard pour effectuer cette tâche
    // Par exemple :
      ...
      <Box>
        ...
        {suggestedDestinationAddresses.map((address, index) => (
          <Typography
            ...
            style={{ color: 'gris', cursor: 'pointer' }}
          >
            {address}
          </Typography>
        ))}
