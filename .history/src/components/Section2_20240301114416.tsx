            						...
            						<div className={styles.frame1}>
              							<div className={styles.frame2}>
                								<div className={styles.frame3}>
													  ...
													  <img className={styles.imguserIcon} alt="" src={imgUser} style={{ width: '3rem', height: '3rem' }} />
													  ...
													  <img className={styles.imgCheck} alt="" src={imgCheck} style={{ width: '3rem', height: '3rem' }}  />
                								...
                								<div className={styles.frame4}>
													  ...
													  <img className={styles.imgCar} alt="" src={imgCar} style={{ width: '3rem', height: '3rem' }}  />
                  									...
                  									<div className={styles.tape3}>
													  <img className={styles.imgDolar} alt="" src={imgDolar} style={{ width: '3rem', height: '3rem' }}  />
