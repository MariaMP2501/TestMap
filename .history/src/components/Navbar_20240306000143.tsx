...
const Navbar: FunctionComponent = () => {
  ...
  const contentWrapperStyle = {
    position: 'relative', // Changer à 'relative' pour empiler les éléments enfants
    display: 'flex',
    justifyContent: 'space-between',
    alignItems: 'center',
    zIndex: 1, // Assurez-vous que le contenu de la Navbar reste au-dessus de l'image de fond
  };
  ...
  const backgroundStyle = {
    ...
    right: 0,
    bottom: 0,
    zIndex: 0, // Réduire le zIndex pour que l'image de fond soit en dessous du contenu
  };
  const logoStyle = {
    width: '7%',
  };
  ...
  return (
    <div style={navbarStyle}>
      <img className="bgcurves" alt="" src={curveSVG}  style={backgroundStyle}/>
