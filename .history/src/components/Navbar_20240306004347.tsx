...
const Navbar: FunctionComponent = () => {
  ...
  // Styles CSS en ligne
  const navbarStyle = {
    backgroundColor: 'red', // Couleur de fond de la navbar
    padding: '10px',
    display: 'flex',
    alignItems: 'center',
  };
  ...
  const leftSectionStyle = {
    display: 'flex',
    alignItems: 'center',
    marginRight: 'auto', // Permet de pousser les éléments à gauche
  };

  const logoStyle = {
    width: '50px',
    height: '50px',
    marginRight: '5px', // Espace entre le logo et le titre
  };
