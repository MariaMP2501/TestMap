    ...
    <Box>
      ...
      <Box>
        ...
        {suggestedOriginAddresses.map((address, index) => (
          <Typography key={index} variant="body2" onClick={() => setOrigin(address)} style={{ color: 'blue', cursor: 'pointer' }}>
            {address}
          </Typography>
        ))}
        <TextField
        ...
        {suggestedDestinationAddresses.map((address, index) => (
          <Typography key={index} variant="body2" onClick={() => setDestination(address)} style={{ color: 'blue', cursor: 'pointer' }}>
            {address}
          </Typography>
        ))}
