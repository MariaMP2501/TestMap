...
const Navbar: FunctionComponent = () => {
  ...
  const buttonsContainerStyle = {
    position: 'absolute',
    top: '1.5rem', // Aligner les boutons verticalement au centre
    ...
    display: 'flex',
    gap: '20px',
    zIndex: 2, // Assurez-vous que les boutons sont placés au-dessus du fond d'image
  };
    ...
    <div className="navbar" style={navbarStyle}>
      ...
      <div style={buttonsContainerStyle}>
          <a style={buttonStyle} className="btnCall icon" onClick={handleCallClick}>
            <CallIcon style={{ fontSize: isMobile ? '10px' : '15px' }} />
          </a>
          <a style={buttonStyle} className="btnMail icon" onClick={handleMailClick}>
            <MailIcon style={{ fontSize: isMobile ? '10px' : '15px' }} />
          </a>
